/* eslint-disable */
define("local_chatbot/popup", ["core/ajax", "core/notification"], function(Ajax, Notification) {
/**
 ...
 */
const init = (welcomeMessage, courseId, strings = {}) => {
    ...
    const submit = () => {
        ...
        filePromise
            ...
            .then((data) => {
                ...
                if (data.error) {
                    addMessage(messages, data.error, "bot");
                    return;
                }
                ...
                if (data.quiz_ready_for_pdf && pendingQuizJson) {
                    ...
                    const _safeFilename = "quiz_" + _coursename.replace(/[^a-zA-Z0-9\u00C0-\u024F\s-]/g,"").trim().replace(/\s+/g,"_") + ".pdf";
                    ...
                    fetch(M.cfg.wwwroot + "/local/chatbot/quiz_pdf.php", {
                        ...
                        body: JSON.stringify({quiz_json: _capturedQuizJson, coursename: _coursename, language: _lang, sesskey: M.cfg.sesskey}),
                    })
                    ...
                    .then((blob) => {
                        ...
                        docIcon.innerHTML = `<svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16"><path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z"/></svg>`;
                    ...
                    .catch(() => { pdfLinkWrap.textContent = strings.pdferror || "Could not generate PDF."; });
                }
            })
            .catch((err) => {
                if (loadingEl && loadingEl.parentNode) {
